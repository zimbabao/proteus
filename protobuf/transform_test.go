...
func (s *TransformerSuite) TestTransform() {
	...
	s.Equal("github.com/zimbabao/proteus/fixtures", pkg.Path)
	...
	s.Equal([]string{
		...
		"google/protobuf/timestamp.proto",
		"github.com/zimbabao/proteus/fixtures/subpkg/generated.proto",
	}, pkg.Imports)
	...
	s.Equal("github.com/zimbabao/proteus/fixtures/subpkg", pkg.Path)
