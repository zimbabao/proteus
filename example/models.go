...
import (
	...
	"github.com/zimbabao/proteus/example/categories"
)

//go:generate proteus -p github.com/zimbabao/proteus/example -f $GOPATH/src/github.com/zimbabao/proteus/example/protos
